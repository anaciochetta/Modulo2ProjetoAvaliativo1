...
public static class PopulationClass
{
    public static void Init()
    {
        ...
        var moto1 = new Motorcycle(2012, "Kavasaki", "ABC-123", 63000, EColors.Vermelho, 500);
        moto1.IsAvailable = true;
        repository.Add(moto1);

        var tricycle1 = new Tricycle(2016, "Trycle Power", "ABC-153", 63000, EColors.Vermelho, 500);
        tricycle1.IsAvailable = false;
        repository.Add(tricycle1);

        var pickup1 = new Pickup(2020, "Amarok", "CVB-963", 100000, EColors.Preto, 2, "Diesel", 600, 800);
